...
TEMPLATE_FILE="${SCRIPT_DIR}/container-source-policy.rb.template"
...
BASE_URL="https://github.com/wharflab/container-source-policy/releases/download/v${VERSION}"
...
SHA256_DARWIN_ARM64="${SHA256_DARWIN_ARM64:-$(fetch_checksum "container-source-policy_${VERSION}_MacOS_arm64.tar.gz")}"
SHA256_DARWIN_AMD64="${SHA256_DARWIN_AMD64:-$(fetch_checksum "container-source-policy_${VERSION}_MacOS_x86_64.tar.gz")}"
SHA256_LINUX_ARM64="${SHA256_LINUX_ARM64:-$(fetch_checksum "container-source-policy_${VERSION}_Linux_arm64.tar.gz")}"
SHA256_LINUX_AMD64="${SHA256_LINUX_AMD64:-$(fetch_checksum "container-source-policy_${VERSION}_Linux_x86_64.tar.gz")}"

echo "Generating formula for container-source-policy v${VERSION}..." >&2
